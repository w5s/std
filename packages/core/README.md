...
| `Promise`                        | `Task.Async`                     | `Task.Async` is like a Promise but lazily evaluated. It has numerous advantages (composable, etc). [See Article](https://dev.to/anthonyjoeseph/should-i-use-fp-ts-task-h52)                                                   |
