...
/**
 * Create a spec for {@link @w5s/core#Numeric.CheckedRemainder} trait
 *
 * @example
 * ```typescript
 * describeCheckedRemainder(Number, [
 *   { call: [2, 3], returns: 6 },
 *   // ...
 * ]);
 *
 ...
 */
export function describeCheckedRemainder<L, R, Ret>(
  subject: Numeric.CheckedRemainder<L, R, Ret>,
