...
# W5S Collection module (array, record, etc) _(@w5s/collection)_
...
[package-version-svg]: https://img.shields.io/npm/v/@w5s/collection.svg?style=flat-square
<!-- AUTO-GENERATED-CONTENT:END -->
<!-- AUTO-GENERATED-CONTENT:START (PKG_JSON:template=[package-url]: https://www.npmjs.com/package/${name}) -->
[package-url]: https://www.npmjs.com/package/@w5s/collection
<!-- AUTO-GENERATED-CONTENT:END -->
...
[license-url]: https://www.npmjs.com/package/@w5s/collection
<!-- AUTO-GENERATED-CONTENT:END -->
