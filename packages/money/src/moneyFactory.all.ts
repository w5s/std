 ...
 * @example
 * ```typescript
 * const money = USD(1);// Money({ currency: Currency({ code: 'USD' }), amount: 1 })
 * ```
 ...
 * @example
 * ```typescript
 * const money = CAD(1);// Money({ currency: Currency({ code: 'CAD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = AED(1);// Money({ currency: Currency({ code: 'AED' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = AFN(1);// Money({ currency: Currency({ code: 'AFN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ALL(1);// Money({ currency: Currency({ code: 'ALL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = AMD(1);// Money({ currency: Currency({ code: 'AMD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ARS(1);// Money({ currency: Currency({ code: 'ARS' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = AUD(1);// Money({ currency: Currency({ code: 'AUD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = AZN(1);// Money({ currency: Currency({ code: 'AZN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BAM(1);// Money({ currency: Currency({ code: 'BAM' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BDT(1);// Money({ currency: Currency({ code: 'BDT' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BGN(1);// Money({ currency: Currency({ code: 'BGN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BHD(1);// Money({ currency: Currency({ code: 'BHD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BIF(1);// Money({ currency: Currency({ code: 'BIF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BND(1);// Money({ currency: Currency({ code: 'BND' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BOB(1);// Money({ currency: Currency({ code: 'BOB' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BRL(1);// Money({ currency: Currency({ code: 'BRL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BWP(1);// Money({ currency: Currency({ code: 'BWP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BYN(1);// Money({ currency: Currency({ code: 'BYN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = BZD(1);// Money({ currency: Currency({ code: 'BZD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CDF(1);// Money({ currency: Currency({ code: 'CDF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CHF(1);// Money({ currency: Currency({ code: 'CHF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CLP(1);// Money({ currency: Currency({ code: 'CLP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CNY(1);// Money({ currency: Currency({ code: 'CNY' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = COP(1);// Money({ currency: Currency({ code: 'COP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CRC(1);// Money({ currency: Currency({ code: 'CRC' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CVE(1);// Money({ currency: Currency({ code: 'CVE' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = CZK(1);// Money({ currency: Currency({ code: 'CZK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = DJF(1);// Money({ currency: Currency({ code: 'DJF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = DKK(1);// Money({ currency: Currency({ code: 'DKK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = DOP(1);// Money({ currency: Currency({ code: 'DOP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = DZD(1);// Money({ currency: Currency({ code: 'DZD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = EEK(1);// Money({ currency: Currency({ code: 'EEK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = EGP(1);// Money({ currency: Currency({ code: 'EGP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ERN(1);// Money({ currency: Currency({ code: 'ERN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ETB(1);// Money({ currency: Currency({ code: 'ETB' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = GBP(1);// Money({ currency: Currency({ code: 'GBP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = GEL(1);// Money({ currency: Currency({ code: 'GEL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = GHS(1);// Money({ currency: Currency({ code: 'GHS' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = GNF(1);// Money({ currency: Currency({ code: 'GNF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = GTQ(1);// Money({ currency: Currency({ code: 'GTQ' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = HKD(1);// Money({ currency: Currency({ code: 'HKD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = HNL(1);// Money({ currency: Currency({ code: 'HNL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = HRK(1);// Money({ currency: Currency({ code: 'HRK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = HUF(1);// Money({ currency: Currency({ code: 'HUF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = IDR(1);// Money({ currency: Currency({ code: 'IDR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ILS(1);// Money({ currency: Currency({ code: 'ILS' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = INR(1);// Money({ currency: Currency({ code: 'INR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = IQD(1);// Money({ currency: Currency({ code: 'IQD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = IRR(1);// Money({ currency: Currency({ code: 'IRR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ISK(1);// Money({ currency: Currency({ code: 'ISK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = JMD(1);// Money({ currency: Currency({ code: 'JMD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = JOD(1);// Money({ currency: Currency({ code: 'JOD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = JPY(1);// Money({ currency: Currency({ code: 'JPY' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = KES(1);// Money({ currency: Currency({ code: 'KES' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = KHR(1);// Money({ currency: Currency({ code: 'KHR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = KMF(1);// Money({ currency: Currency({ code: 'KMF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = KRW(1);// Money({ currency: Currency({ code: 'KRW' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = KWD(1);// Money({ currency: Currency({ code: 'KWD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = KZT(1);// Money({ currency: Currency({ code: 'KZT' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = LBP(1);// Money({ currency: Currency({ code: 'LBP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = LKR(1);// Money({ currency: Currency({ code: 'LKR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = LTL(1);// Money({ currency: Currency({ code: 'LTL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = LVL(1);// Money({ currency: Currency({ code: 'LVL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = LYD(1);// Money({ currency: Currency({ code: 'LYD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MAD(1);// Money({ currency: Currency({ code: 'MAD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MDL(1);// Money({ currency: Currency({ code: 'MDL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MGA(1);// Money({ currency: Currency({ code: 'MGA' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MKD(1);// Money({ currency: Currency({ code: 'MKD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MMK(1);// Money({ currency: Currency({ code: 'MMK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MOP(1);// Money({ currency: Currency({ code: 'MOP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MUR(1);// Money({ currency: Currency({ code: 'MUR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MXN(1);// Money({ currency: Currency({ code: 'MXN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MYR(1);// Money({ currency: Currency({ code: 'MYR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = MZN(1);// Money({ currency: Currency({ code: 'MZN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = NAD(1);// Money({ currency: Currency({ code: 'NAD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = NGN(1);// Money({ currency: Currency({ code: 'NGN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = NIO(1);// Money({ currency: Currency({ code: 'NIO' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = NOK(1);// Money({ currency: Currency({ code: 'NOK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = NPR(1);// Money({ currency: Currency({ code: 'NPR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = NZD(1);// Money({ currency: Currency({ code: 'NZD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = OMR(1);// Money({ currency: Currency({ code: 'OMR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = PAB(1);// Money({ currency: Currency({ code: 'PAB' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = PEN(1);// Money({ currency: Currency({ code: 'PEN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = PHP(1);// Money({ currency: Currency({ code: 'PHP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = PKR(1);// Money({ currency: Currency({ code: 'PKR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = PLN(1);// Money({ currency: Currency({ code: 'PLN' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = PYG(1);// Money({ currency: Currency({ code: 'PYG' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = QAR(1);// Money({ currency: Currency({ code: 'QAR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = RON(1);// Money({ currency: Currency({ code: 'RON' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = RSD(1);// Money({ currency: Currency({ code: 'RSD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = RUB(1);// Money({ currency: Currency({ code: 'RUB' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = RWF(1);// Money({ currency: Currency({ code: 'RWF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = SAR(1);// Money({ currency: Currency({ code: 'SAR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = SDG(1);// Money({ currency: Currency({ code: 'SDG' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = SEK(1);// Money({ currency: Currency({ code: 'SEK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = SGD(1);// Money({ currency: Currency({ code: 'SGD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = SOS(1);// Money({ currency: Currency({ code: 'SOS' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = SYP(1);// Money({ currency: Currency({ code: 'SYP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = THB(1);// Money({ currency: Currency({ code: 'THB' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = TND(1);// Money({ currency: Currency({ code: 'TND' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = TOP(1);// Money({ currency: Currency({ code: 'TOP' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = TRY(1);// Money({ currency: Currency({ code: 'TRY' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = TTD(1);// Money({ currency: Currency({ code: 'TTD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = TWD(1);// Money({ currency: Currency({ code: 'TWD' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = TZS(1);// Money({ currency: Currency({ code: 'TZS' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = UAH(1);// Money({ currency: Currency({ code: 'UAH' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = UGX(1);// Money({ currency: Currency({ code: 'UGX' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = UYU(1);// Money({ currency: Currency({ code: 'UYU' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = UZS(1);// Money({ currency: Currency({ code: 'UZS' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = VEF(1);// Money({ currency: Currency({ code: 'VEF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = VND(1);// Money({ currency: Currency({ code: 'VND' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = XAF(1);// Money({ currency: Currency({ code: 'XAF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = XOF(1);// Money({ currency: Currency({ code: 'XOF' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = YER(1);// Money({ currency: Currency({ code: 'YER' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ZAR(1);// Money({ currency: Currency({ code: 'ZAR' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ZMK(1);// Money({ currency: Currency({ code: 'ZMK' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
 ...
 * @example
 * ```typescript
 * const money = ZWL(1);// Money({ currency: Currency({ code: 'ZWL' }), amount: 1 })
 * ```
 * @param amount - The amount of money
 */
