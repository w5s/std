import { describeAdd, describeMultiply, describePower, describeSubtract } from '@w5s/core/Testing';
...
describe('TimeDurationNumeric', () => {
  ...
  describePower(subject, [
    { call: [TimeDuration(1), 1], returns: 1 },
    { call: [TimeDuration(2), 3], returns: 8 },
    { call: [TimeDuration(3), 2], returns: 9 },
  ]);
});
