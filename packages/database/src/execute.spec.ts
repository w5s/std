...
describe('executeQuery', () => {
  ...
  it('should forward query execution to environment', async () => {
    ...
    await unsafeRun(executeQuery(client, anyQuery));
  ...
  it('should return Result.Ok of environment.executeQuery if promise resolved', async () => {
    ...
    await expect(unsafeRun(executeQuery(client, anyQuery))).resolves.toEqual(Result.Ok('TestReturn'));
  });
  ...
  it('should return Result.Error of environment.executeQuery if promise rejected', async () => {
    ...
    await expect(unsafeRun(executeQuery(client, anyQuery))).resolves.toEqual(
  ...
  it('should convert to sql statement', async () => {
    ...
    await unsafeRun(executeQuery(client, SQLQuery.CreateSchema({ schemaName: 'test' })));
