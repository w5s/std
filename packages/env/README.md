...
# W5S Environment variable module _(@w5s/env)_
...
[package-version-svg]: https://img.shields.io/npm/v/@w5s/env.svg?style=flat-square
<!-- AUTO-GENERATED-CONTENT:END -->
<!-- AUTO-GENERATED-CONTENT:START (PKG_JSON:template=[package-url]: https://www.npmjs.com/package/${name}) -->
[package-url]: https://www.npmjs.com/package/@w5s/env
<!-- AUTO-GENERATED-CONTENT:END -->
...
[license-url]: https://www.npmjs.com/package/@w5s/env
<!-- AUTO-GENERATED-CONTENT:END -->
